...
WORKDIR="$HOME/polybenchGpu/CUDA/3MM"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/3mm_kernel_energy/$RUNSTAMP"
...
KERNEL_NAMES=("mm3_kernel1" "mm3_kernel2" "mm3_kernel3")
KERNEL_EXES=(
  "./01_3mm_kernel1_repeat.exe"
  "./02_3mm_kernel2_repeat.exe"
  "./03_3mm_kernel3_repeat.exe"
)
