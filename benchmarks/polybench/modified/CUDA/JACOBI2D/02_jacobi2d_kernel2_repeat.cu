/**
 * 02_jacobi2d_kernel2_repeat.cu
 *
 * Isolated measurement for runJacobiCUDA_kernel2.
 *
 * Measures a single runJacobiCUDA_kernel2 launch
...
void runJacobi2DCUDAKernel2Only(
    int n,
    DATA_TYPE POLYBENCH_2D(A,N,N,n,n),
    DATA_TYPE POLYBENCH_2D(B,N,N,n,n),
    DATA_TYPE POLYBENCH_2D(A_outputFromGpu,N,N,n,n))
{
...

    {
        ...
        printf("RESULT kernel=jacobi2d_kernel2\n");
