...
WORKDIR="$HOME/polybenchGpu/CUDA/JACOBI2D"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/jacobi2d_kernel_energy/$RUNSTAMP"
...
KERNEL_NAMES=("kernel1" "kernel2")
KERNEL_EXES=(
  "./01_jacobi2d_kernel1_repeat.exe"
  "./02_jacobi2d_kernel2_repeat.exe"
)

WORKLOAD_PREFIX="jacobi2d"
