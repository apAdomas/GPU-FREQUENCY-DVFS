...
WORKDIR="$HOME/polybenchGpu/CUDA/GRAMSCHMIDT"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/gramschmidt_kernel_energy/$RUNSTAMP"
...
KERNEL_NAMES=("kernel1" "kernel2" "kernel3")
KERNEL_EXES=(
  "./01_gramschmidt_kernel1_repeat.exe"
  "./02_gramschmidt_kernel2_repeat.exe"
  "./03_gramschmidt_kernel3_repeat.exe"
)

WORKLOAD_PREFIX="gramschmidt"
