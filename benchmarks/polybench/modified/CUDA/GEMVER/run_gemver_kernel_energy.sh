...
WORKDIR="$HOME/polybenchGpu/CUDA/GEMVER"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/gemver_kernel_energy/$RUNSTAMP"
...
KERNEL_NAMES=("gemver_kernel1" "gemver_kernel2" "gemver_kernel3")
KERNEL_EXES=(
  "./01_gemver_kernel1_repeat.exe"
  "./02_gemver_kernel2_repeat.exe"
  "./03_gemver_kernel3_repeat.exe"
)

WORKLOAD_PREFIX="gemver"
