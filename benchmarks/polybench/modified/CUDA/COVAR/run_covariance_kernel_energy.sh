...
WORKDIR="$HOME/polybenchGpu/CUDA/COVAR"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/covariance_kernel_energy/$RUNSTAMP"
...
KERNEL_NAMES=("mean_kernel" "reduce_kernel" "covar_kernel")
KERNEL_EXES=(
  "./01_covariance_mean_kernel_repeat.exe"
  "./02_covariance_reduce_kernel_repeat.exe"
  "./03_covariance_covar_kernel_repeat.exe"
)

WORKLOAD_PREFIX="covariance"
