...
WORKDIR="$HOME/polybenchGpu/CUDA/ATAX"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/atax_kernel_energy/$RUNSTAMP"
...
KERNEL_NAMES=("atax_kernel1" "atax_kernel2")
KERNEL_EXES=(
  "./01_atax_kernel1_repeat.exe"
  "./02_atax_kernel2_repeat.exe"
)

WORKLOAD_PREFIX="atax"
