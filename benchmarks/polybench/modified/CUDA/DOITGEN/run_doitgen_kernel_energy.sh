...
WORKDIR="$HOME/polybenchGpu/CUDA/DOITGEN"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/doitgen_kernel_energy/$RUNSTAMP"
...
KERNEL_EXES=(
  "./01_doitgen_kernel1_repeat.exe"
  "./02_doitgen_kernel2_repeat.exe"
)

WORKLOAD_PREFIX="doitgen"
