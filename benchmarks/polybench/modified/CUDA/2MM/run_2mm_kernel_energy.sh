...
WORKDIR="$HOME/polybenchGpu/CUDA/2MM"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/2mm_kernel_energy/$RUNSTAMP"
...
KERNEL_NAMES=("mm2_kernel1" "mm2_kernel2")
KERNEL_EXES=(
  "./01_2mm_kernel1_repeat.exe"
  "./02_2mm_kernel2_repeat.exe"
)
