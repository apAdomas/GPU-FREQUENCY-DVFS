...
WORKDIR="$HOME/polybenchGpu/CUDA/SYRK"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/syrk_kernel_energy/$RUNSTAMP"
...
KERNEL_NAMES=("syrk_kernel")
KERNEL_EXES=(
  "./01_syrk_kernel_repeat.exe"
)

WORKLOAD_PREFIX="syrk"
