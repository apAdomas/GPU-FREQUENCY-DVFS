...
WORKDIR="$HOME/polybenchGpu/CUDA/JACOBI1D"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/jacobi1d_kernel_energy/$RUNSTAMP"
...
KERNEL_NAMES=("step1" "step2")
KERNEL_EXES=(
  "./01_jacobi1d_step1_repeat.exe"
  "./02_jacobi1d_step2_repeat.exe"
)

WORKLOAD_PREFIX="jacobi1d"
