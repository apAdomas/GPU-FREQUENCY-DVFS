...
WORKDIR="$HOME/polybenchGpu/CUDA/2DCONV"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/2dconv_kernel_energy/$RUNSTAMP"
...
KERNEL_NAMES=("convolution2D_kernel")
KERNEL_EXES=(
  "./01_2dconv_kernel_repeat.exe"
)

WORKLOAD_PREFIX="2dconv"
