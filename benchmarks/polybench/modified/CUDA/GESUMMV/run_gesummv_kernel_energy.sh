...
WORKDIR="$HOME/polybenchGpu/CUDA/GESUMMV"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/gesummv_kernel_energy/$RUNSTAMP"
...
KERNEL_NAMES=("gesummv_kernel")
KERNEL_EXES=(
  "./01_gesummv_kernel_repeat.exe"
)

WORKLOAD_PREFIX="gesummv"
