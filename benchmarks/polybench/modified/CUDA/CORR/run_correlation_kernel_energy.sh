...
WORKDIR="$HOME/polybenchGpu/CUDA/CORR"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/correlation_kernel_energy/$RUNSTAMP"
...
KERNEL_NAMES=("mean_kernel" "std_kernel" "reduce_kernel" "corr_kernel")
KERNEL_EXES=(
  "./01_correlation_mean_kernel_repeat.exe"
  "./02_correlation_std_kernel_repeat.exe"
  "./03_correlation_reduce_kernel_repeat.exe"
  "./04_correlation_corr_kernel_repeat.exe"
)

WORKLOAD_PREFIX="correlation"
