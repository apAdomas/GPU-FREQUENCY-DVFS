...
OUTDIR="$HOME/thesis/results/fdtd2d_kernel_energy/$RUNSTAMP"

CORE_CLOCKS=(210 630 1050 1470 1890 2100)
MEM_CLOCKS=(405 810 5001 9251 9501)

REPEATS=1
SLEEP_AFTER_CLOCK_LOCK=3
...
KERNEL_NAMES=("step1" "step2" "step3")
KERNEL_EXES=(
  "./01_fdtd2d_step1_repeat.exe"
  "./02_fdtd2d_step2_repeat.exe"
  "./03_fdtd2d_step3_repeat.exe"
)

WORKLOAD_PREFIX="fdtd2d"
