...
WORKDIR="$HOME/polybenchGpu/CUDA/BICG"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/bicg_kernel_energy/$RUNSTAMP"
...
KERNEL_NAMES=("bicg_kernel1" "bicg_kernel2")
KERNEL_EXES=(
  "./01_bicg_kernel1_repeat.exe"
  "./02_bicg_kernel2_repeat.exe"
)

WORKLOAD_PREFIX="bicg"
