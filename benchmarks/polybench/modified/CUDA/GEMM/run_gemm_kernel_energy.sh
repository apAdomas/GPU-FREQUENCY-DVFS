...
WORKDIR="$HOME/polybenchGpu/CUDA/GEMM"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/gemm_kernel_energy/$RUNSTAMP"
...
KERNEL_NAMES=("gemm_kernel")
KERNEL_EXES=(
  "./01_gemm_kernel_repeat.exe"
)

WORKLOAD_PREFIX="gemm"
