...
WORKDIR="$HOME/parboil_2.5/benchmarks/lbm/src/cuda"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/lbm_kernel_energy/$RUNSTAMP"
WORKLOAD_PREFIX="lbm"

LBM_INPUT="$HOME/parboil_2.5/datasets/lbm/short/input/120_120_150_ldc.of"
...
KERNEL_NAMES=("streamcollide")
KERNEL_EXES=("./01_lbm_streamcollide_repeat.exe")
KERNEL_ARGS=("$LBM_INPUT")
