...
WORKDIR="$HOME/rodinia_3.1/cuda/kmeans"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/kmeans_kernel_energy/$RUNSTAMP"
...
KERNEL_EXES=(
  "./01_kmeans_kmeansPoint_repeat.exe"
)

WORKLOAD_PREFIX="kmeans"
