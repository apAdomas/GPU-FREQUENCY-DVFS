...
WORKDIR="$HOME/rodinia_3.1/cuda/lavaMD"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/lavamd_kernel_energy/$RUNSTAMP"
...
KERNEL_EXES=(
  "./01_lavamd_kernel_gpu_cuda_repeat.exe"
)

WORKLOAD_PREFIX="lavamd"
