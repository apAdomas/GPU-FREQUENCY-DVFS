/**
 * 04_pre_euler3d_time_step_repeat.cu
 *
 * Isolated measurement for Rodinia CFD pre_euler3d time_step.
 *
 * Setup:
 * 1) load mesh
 ...
 */
     ...
     float* fluxes)
 {
     ...
     checkCuda(cudaGetLastError(), "launch pre_euler3d_time_step");
 }
