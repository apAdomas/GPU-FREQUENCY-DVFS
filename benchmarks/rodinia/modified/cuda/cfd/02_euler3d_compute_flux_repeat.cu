/**
 * 02_euler3d_compute_flux_repeat.cu
 *
 * Isolated measurement for regular Rodinia CFD euler3d compute_flux.
 *
 * Measures a single cuda_compute_flux launch repeatedly for energy/time measurement.
 */
     ...
     float* fluxes)
 {
     ...
     checkCuda(cudaGetLastError(), "launch euler3d_compute_flux");
 }
