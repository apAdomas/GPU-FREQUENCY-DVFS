...
OUTDIR="$HOME/thesis/results/euler3d_kernel_energy/$RUNSTAMP"
...
KERNEL_EXES=(
  "./01_euler3d_compute_step_factor_repeat.exe"
  "./02_euler3d_compute_flux_repeat.exe"
  "./03_euler3d_time_step_repeat.exe"
)

WORKLOAD_PREFIX="euler3d"
