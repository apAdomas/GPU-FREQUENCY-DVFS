...
WORKDIR="$HOME/rodinia_3.1/cuda/myocyte"
RUNSTAMP="$(date +%Y%m%d_%H%M%S)"
OUTDIR="$HOME/thesis/results/myocyte_kernel_energy/$RUNSTAMP"
...
KERNEL_EXES=(
  "./01_myocyte_solver_2_repeat.exe"
)

WORKLOAD_PREFIX="myocyte"
...
run_case() {
...

  {
    ...
    echo "xmax=$XMAX"
    echo "workload_instances=$WORKLOAD"
